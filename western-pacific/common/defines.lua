...
NEconomy = {
	...
	MAX_TRADE_POSTS_BASE = 0,
	MIN_TRADE_POSTS = 0,							-- Minimum number of max trade posts per patrician
	MIN_TRADETECH_LEVEL_FOR_TPS = 8,				-- Minimum tech level needed to build trade posts
	TRADETECH_LEVEL_FOR_BASE_TPS = 8,
	...
	DOGE_SUCC_RANDOM_FACTOR = 550,					-- The random Respect factor on actual Doge succession
